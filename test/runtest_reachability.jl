@testset "propagate" begin
    ...
    states_forward = propagate(states_ref, A, a_min, a_max, Δt)
    @test isequal(states_forward, states_ref_forward)
    states = copy(states_ref)
    propagate!(states, A, a_min, a_max, Δt)
    @test isequal(states, states_ref_forward)
end
...
@testset "propagate backward" begin
    ...
    states_backward = propagate_backward(states_ref, A, a_min, a_max, Δt)
    @test isequal(states_backward, states_ref_backward)
    states = copy(states_ref)
    propagate_backward!(states, A, a_min, a_max, Δt)
    @test isequal(states, states_ref_backward)
end
